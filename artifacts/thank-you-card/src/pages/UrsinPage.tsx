...
export default function UrsinPage() {
  ...
  const opacityNebula = useTransform(
    scrollYProgress,
    [0, 0.5, 1],
    [0.3, 0.6, 0.1],
  );
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-screen text-white font-sans selection:bg-cyan-500/50 overflow-hidden relative"
      style={{
        background:
          "linear-gradient(135deg, #1e1b4b 0%, #312e81 30%, #1e3a8a 70%, #0c4a6e 100%)",
      }}
    >
      <ParticleField
      ...
      <div className="absolute top-[10%] left-[20%] text-white text-xs opacity-50 font-mono pointer-events-none">
        ✦ - - - ✦
      </div>
      <div className="absolute top-[30%] right-[15%] text-white text-xs opacity-50 font-mono pointer-events-none">
        ★ - ✦ - - - ★
      </div>
      <div className="absolute bottom-[20%] left-[10%] text-white text-xs opacity-50 font-mono pointer-events-none">
        ✦ - - ★ - ✦
      </div>
      ...
      <div className="fixed top-6 left-6 z-50">
        <Link
          href="/"
          className="text-cyan-300/70 hover:text-cyan-300 transition-colors flex items-center gap-2 group text-sm tracking-wider uppercase font-mono font-bold"
        >
          <ArrowLeft
            size={16}
      ...
      <main className="max-w-4xl mx-auto px-6 py-24 relative z-10">
        ...
        <section className="min-h-[80vh] flex flex-col justify-center items-center text-center">
          ...
          >
            {/* Orbital Rings */}
            <svg
              className="absolute -inset-8 w-32 h-32 animate-spin-slow pointer-events-none"
              viewBox="0 0 100 100"
            >
              <circle
                cx="50"
            ...
            <svg
              className="absolute -inset-12 w-40 h-40 animate-reverse-spin pointer-events-none"
              viewBox="0 0 100 100"
            >
              <circle
                cx="50"
            ...
            <Orbit
              size={100}
              className="text-cyan-300/40 absolute -inset-2 animate-spin-slow"
            />
            <Rocket
              size={48}
              className="text-white relative z-10 drop-shadow-[0_0_15px_rgba(34,211,238,0.8)]"
            />
          </motion.div>
        ...
        <ScrollReveal className="py-24 text-center max-w-2xl mx-auto">
          <div className="p-8 rounded-3xl bg-indigo-950/40 border border-indigo-400/30 backdrop-blur-md">
            <p className="text-2xl md:text-3xl leading-relaxed font-bold text-white font-orbitron">
              "While others look down at their feet, you look up towards the
              stars. Thank you for expanding my horizon and showing me the
              beauty of curiosity."
            </p>
          </div>
        </ScrollReveal>
            ...
            {[
              {
                ...
                text: "I am constantly in awe of how your mind works, for better or for worse. You don't just accept surface-level answers; you dig until you find the truth.",
              },
              {
                icon: Sparkles,
                title: "Infinite Wonder",
                text: "Your passion for the unknown is contagious. You remind me that there is more to the universe, and our possibilities within it are limitless.",
              },
            ].map((item, i) => (
              <ScrollReveal key={item.title} delay={i * 0.2}>
                <div className="flex gap-6 items-start group bg-white/5 border border-cyan-500/20 p-8 rounded-3xl hover:bg-white/10 transition-all hover:border-cyan-400/50">
                  ...
                  <div>
                    <h3 className="text-2xl mb-3 font-orbitron font-bold text-white tracking-wider">
                      {item.title}
                    </h3>
        ...
        <section className="py-32 relative">
          ...
          <ScrollReveal className="text-center relative z-10 p-12 border border-purple-500/30 rounded-3xl bg-black/20 backdrop-blur-sm">
            <h2 className="text-4xl md:text-6xl font-orbitron font-bold tracking-widest mb-8 text-[#c084fc] drop-shadow-[0_0_15px_rgba(192,132,252,0.5)]">
              Reach for the Stars, and fall amongst the Clouds
            </h2>
            <p className="text-xl text-white font-medium max-w-2xl mx-auto leading-relaxed">
              Your potential is as boundless as the cosmos you admire. I can't
              wait to see what discoveries you make, what boundaries you push,
              and what worlds you continue to build.
            </p>
          </ScrollReveal>
        </section>
        ...
        <ScrollReveal className="py-24 text-center">
          <div className="font-mono text-sm text-cyan-400/80 tracking-[0.4em] mb-4">
            END_TRANSMISSION
          </div>
          <div className="w-2 h-16 bg-gradient-to-b from-[#22d3ee] to-transparent mx-auto mb-8 rounded-full" />
          <p className="font-orbitron font-bold text-3xl text-white tracking-widest">
