...
export default function DricoPage() {
  return (
    <motion.div
      ...
      style={{
        background:
          "linear-gradient(135deg, #f0fdf4 0%, #e0f2fe 50%, #fefce8 100%)",
      }}
    >
      ...
      <div className="absolute bottom-[20%] left-[5%] text-[#0ea5e9] text-6xl font-black opacity-20 pointer-events-none transform -rotate-12">
        ⚡
      </div>
      ...
      <div className="fixed top-6 left-6 z-50">
        <Link
          href="/"
          className="text-green-600/70 hover:text-green-700 transition-colors flex items-center gap-2 group text-sm tracking-wider uppercase font-bold"
        >
          <ArrowLeft
            size={16}
      ...
      <main className="max-w-5xl mx-auto px-6 py-20 relative z-10">
        ...
        <ScrollReveal className="py-20 text-center max-w-3xl mx-auto">
          <p className="text-3xl md:text-4xl font-black font-bebas tracking-wide text-[#166534] leading-tight bg-white/60 p-8 rounded-3xl border-4 border-green-200 shadow-xl transform rotate-1">
            "You bring the noise, the hype, and the life to every room you walk
            into. Thank you for never dimming your light and always bringing the
            energy we all need."
          </p>
        </ScrollReveal>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <ScrollReveal yOffset={100}>
              <div className="bg-white/90 p-8 rounded-3xl border-4 border-green-200 relative overflow-hidden group shadow-[0_8px_30px_rgba(34,197,94,0.15)] hover:shadow-[0_8px_30px_rgba(34,197,94,0.3)] hover:-translate-y-2 transition-all">
                ...
                <h3 className="text-4xl font-bebas tracking-wider text-[#15803d] mb-4">
                  The Best Memories
                </h3>
                <p className="text-[#1e3a8a] font-bold leading-relaxed text-lg">
                  From screaming at the TV during Netflix show runs to the
                  inside jokes that only we understand. The chaotic, hilarious
                  moments are the ones I cherish the most.
                </p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal yOffset={100} delay={0.2}>
              <div className="bg-white/90 p-8 rounded-3xl border-4 border-green-200 relative overflow-hidden group shadow-[0_8px_30px_rgba(34,197,94,0.15)] hover:shadow-[0_8px_30px_rgba(34,197,94,0.3)] hover:-translate-y-2 transition-all">
                ...
                <h3 className="text-4xl font-bebas tracking-wider text-[#0369a1] mb-4">
                  Unmatched Vibe
                </h3>
                <p className="text-[#1e3a8a] font-bold leading-relaxed text-lg">
                  It's (almost) impossible to be in a bad mood around you. You
                  have this ridiculous ability to lift people up just by being
                  yourself. Never lose that spark.
                </p>
              </div>
            </ScrollReveal>
          </div>
        ...
        <section className="py-24 text-center">
          <ScrollReveal>
            ...
            <h2 className="text-5xl md:text-7xl font-bebas tracking-wider text-[#166534] mb-8">
            ...
            <p className="text-2xl text-[#1e3a8a] font-bold max-w-2xl mx-auto leading-relaxed bg-white/50 p-6 rounded-2xl">
              I see how much heart you put into the things you love. Keep
              grinding, keep pushing, and keep that hunger. I'll always be
        ...
        <ScrollReveal className="py-20 text-center">
          ...
          <p className="font-bebas text-6xl text-[#15803d] tracking-wider mb-4">
            Love you lots.
          </p>
          <p className="text-[#0369a1] uppercase tracking-[0.2em] text-lg font-black bg-white inline-block px-6 py-2 rounded-xl shadow-sm border-2 border-blue-200">
            Always in your corner, Kemi
          </p>
        </ScrollReveal>
      </main>
    </motion.div>
