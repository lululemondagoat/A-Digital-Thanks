...
export default function KemiPage() {
  return (
    <motion.div
      ...
      style={{
        background:
          "linear-gradient(180deg, #1a1400 0%, #2d2000 40%, #1a1000 100%)",
      }}
    >
      {/* Gold rain effect */}
      ...
      <div className="absolute top-[10%] right-[20%] text-[#d4af37] opacity-40 text-2xl font-serif pointer-events-none">
        ✦
      </div>
      <div className="absolute bottom-[30%] left-[10%] text-[#d4af37] opacity-30 text-xl font-serif pointer-events-none">
        ★
      </div>
      <div className="absolute top-[40%] left-[80%] text-[#d4af37] opacity-50 text-3xl font-serif pointer-events-none">
        ✦
      </div>
      ...
      <div className="fixed top-6 left-6 z-50">
        <Link
          href="/"
          className="text-[#d4af37]/70 hover:text-[#d4af37] transition-colors flex items-center gap-2 group text-sm tracking-widest uppercase font-bold"
        >
          <ArrowLeft
            size={16}
      ...
      <main className="max-w-3xl mx-auto px-6 py-24 relative z-10">
        ...
        <ScrollReveal className="py-24 text-center">
          <p className="text-2xl md:text-3xl leading-relaxed font-playfair italic text-[#f5e6c8] bg-[#1a1200]/60 border border-[#d4af37]/20 rounded-2xl backdrop-blur p-10 shadow-2xl">
            "I spend so much time thanking the people around me, lifting them
            up, and celebrating their wins. It is time I paused, looked in the
            mirror, and thanked myself."
          </p>
        </ScrollReveal>
          ...
          <div className="space-y-12">
            <ScrollReveal>
              <div className="text-center mb-12 bg-[#1a1200]/60 border border-[#d4af37]/20 rounded-2xl backdrop-blur p-12">
                ...
                <h2 className="font-playfair italic text-4xl text-[#f5c842] mb-6">
                  For the storms I survived, For the people I've gained as my
                  own
                </h2>
                <p className="text-xl text-[#fef9e7] font-medium leading-relaxed max-w-2xl mx-auto">
                  For the days when getting out of bed felt impossible, but I
                  did it anyway. For the resilience I've built. For the love
                  I've found both inside and all around me.
                </p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.2}>
              <div className="text-center mb-12 bg-[#1a1200]/60 border border-[#d4af37]/20 rounded-2xl backdrop-blur p-12">
                ...
                <h2 className="font-playfair italic text-4xl text-[#f5c842] mb-6">
                  For the grace I've found
                </h2>
                <p className="text-xl text-[#fef9e7] font-medium leading-relaxed max-w-2xl mx-auto">
                  For learning to be gentle with my own failures, that rejection
                  is often redirection. For realising that my worth is not tied
                  to my productivity.
                </p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.4}>
              <div className="text-center bg-[#1a1200]/60 border border-[#d4af37]/20 rounded-2xl backdrop-blur p-12">
                ...
                <h2 className="font-playfair italic text-4xl text-[#f5c842] mb-6">
                  For the ambition I hold
                </h2>
                <p className="text-xl text-[#fef9e7] font-medium leading-relaxed max-w-2xl mx-auto">
                  For never settling. For wanting more for my life and having
                  the courage to pursue it. The passion to grow is a beautiful
                  thing, and I will trust the journey.
                </p>
              </div>
            </ScrollReveal>
          </div>
        ...
        <ScrollReveal className="py-32 relative">
          ...
          <div className="p-16 text-center">
            <h2 className="font-nunito font-bold text-xl tracking-[0.4em] text-[#d4af37] uppercase mb-8">
              My Promise
            </h2>
            <p className="text-2xl font-playfair italic leading-relaxed text-white mb-12 max-w-xl mx-auto">
              I promise to stop letting my rejections and failures dictate who I
              am. I promise to protect my peace, celebrate my light, and trust
              my own resilience. I am successful, just as I am.
            </p>
            <div className="flex flex-col items-center gap-6">
              <div className="w-[2px] h-16 bg-gradient-to-b from-[#d4af37] to-transparent" />
              <span className="font-playfair text-4xl text-[#d4af37]">
                Thank you for your authenticity always, Myself
              </span>
            </div>
          </div>
        </ScrollReveal>
