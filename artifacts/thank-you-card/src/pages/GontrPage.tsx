...
export default function GontrPage() {
  return (
    <motion.div
      ...
      style={{ background: 'linear-gradient(135deg, #fefce8 0%, #f0fdf4 50%, #fffbeb 100%)' }}
    >
      ...
      <div className="absolute top-[20%] right-[5%] opacity-10 pointer-events-none">
        <svg width="200" height="200" viewBox="0 0 24 24" fill="none" stroke="#14532d" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
          <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-13h2v6h-2zm0 8h2v2h-2z" />
        </svg>
      </div>

      <div className="fixed top-6 left-6 z-50">
        <Link href="/" className="text-[#92400e] hover:text-[#78350f] transition-colors flex items-center gap-2 group text-sm tracking-wider uppercase font-bold">
      ...
      <main className="max-w-4xl mx-auto px-6 py-24 relative z-10">
        ...
        <section className="py-24">
          <ScrollReveal>
            <div className="flex items-center gap-4 mb-16">
              ...
              <h2 className="font-cormorant text-3xl font-bold text-[#1a3a1a] uppercase tracking-wider">Lessons Learned</h2>
            ...
            {[
              ...
              <ScrollReveal key={item.title} delay={i * 0.2}>
                <div className="p-8 border-2 border-[#d4af37]/30 bg-[#fef9e7] rounded-2xl shadow-[0_10px_30px_rgba(212,175,55,0.1)] hover:shadow-[0_15px_40px_rgba(212,175,55,0.2)] transition-all hover:-translate-y-2 h-full group relative overflow-hidden">
                  ...
                  <h3 className="text-2xl mb-3 font-cormorant font-bold text-[#1a3a1a]">{item.title}</h3>
        ...
        <section className="py-24 max-w-2xl mx-auto">
          <ScrollReveal>
            <h2 className="font-cormorant text-4xl font-bold mb-12 text-center text-[#1a3a1a]">What I Admire Most</h2>
          </ScrollReveal>
            ...
            {[
              ...
              <ScrollReveal key={i} delay={i * 0.15}>
                <div className="flex items-center gap-6 p-6 border-2 border-white bg-white/60 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <p className="text-[#14532d] font-bold tracking-wide text-lg">{text}</p>
                </div>
              </ScrollReveal>
            ))}
          </div>
        ...
        <ScrollReveal className="py-32 text-center border-t-2 border-[#86efac] mt-12">
          ...
          <div className="inline-block bg-[#1a3a1a] text-[#fefce8] px-12 py-8 rounded-3xl shadow-xl transform rotate-1">
            <span className="block text-sm text-[#d4af37] font-bold tracking-[0.2em] uppercase mb-4">With utmost respect</span>
            <span className="font-cormorant font-bold text-5xl tracking-widest text-[#fef9e7]">Thank You</span>
          </div>
        </ScrollReveal>
      </main>
    </motion.div>
